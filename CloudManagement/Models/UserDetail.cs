...
namespace CloudManagement.Models
{
    ...
    public class UserDetail
    {
        ...
        {
            return "UserDetailId=" + UserDetailId + ",UserPrincipalName=" + UserPrincipalName + ",AccountEnabled=" + AccountEnabled + ",Password=" + Password + ",MailNickname=" + MailNickname + ",DisplayName=" + DisplayName + ",GivenName=" + GivenName + ",Surname=" + Surname + ",JobTitle=" + JobTitle + ",Department=" + Department + ",StreetAddress=" + StreetAddress + ",City=" + City + ",State=" + State + ",Country=" + Country + ",PhysicalDeliveryOfficeName=" + PhysicalDeliveryOfficeName + ",TelephoneNumber=" + TelephoneNumber + ",PostalCode=" + PostalCode + ",Photo=" + Photo;
        }
        #endregion Model
    }
}
